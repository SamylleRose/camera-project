...
O README do servidor já está presente em na pastar server e explica:
...
Se quiser adicionar um passo sobre como mudar a porta ou IP, edite o início do arquivo server.py:
